...
function Navigation() {
  ...
  return (
    <div class="flex flex-col p-6 h-full items-center justify-between overflow-hidden border-darkBlue-200 border-b-2 bg-white md:flex-row md:h-14 2xl:px-36 dark:border-white dark:bg-darkBlue-200">
      <div className="flex flex-row mb-3 md:mb-0">
        <a className="text-md" href="#intro">
          <span className="font-geistBold text-darkBlue-200 dark:text-white">GARRETT</span>
      ...
      <div className="flex flex-row items-center justify-between w-[80%] text-darkBlue-200 md:justify-between md:w-[40%] dark:text-white">
